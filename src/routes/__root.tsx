...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cursorbike — kola, elektrokola a servis v Kravařích" },
      {
        name: "description",
        content: "Prodejna a servis jízdních kol Cursorbike. Osobní přístup, vybraná kola a elektrokola skladem.",
      },
      { name: "author", content: "Cursorbike" },
