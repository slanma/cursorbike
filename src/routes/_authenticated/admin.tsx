...
import { Bike, ClipboardList, Download, LayoutGrid, LogOut, Mail, Settings, Users, Wrench } from "lucide-react";
...
const odkazy = [
  ...
  { to: "/admin/feedy", label: "Import", icon: Download, exact: false },
